...
import (
	...
	"github.com/tfdriftctl/tfdriftctl/internal/api"
...
func main() {
	cfgPath := flag.String("config", "configs/tfdriftctl.yaml", "path to config file")
	flag.Parse()
	...
	if err := api.Run(runCtx, cfg.API, srv.Handler()); err != nil {
